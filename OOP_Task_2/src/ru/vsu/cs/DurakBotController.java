...
public class DurakBotController {
    ...
    private boolean takeCardsButClicked = false;
    ...
    private void initialize() {
        ...
        //игра
        //durak(userHand, enemyHand);
    }

    private void battleFieldDraw() {
        if (!anchorPane.getChildren().contains(battleField)) {
            anchorPane.getChildren().add(battleField);
        }
        battleField.setLayoutX(300);
        battleField.setLayoutY(250);
    }
    ...
    private void prepareForGame(Hand userHand, Hand enemyHand, Card trumpCard) {
        ...
        defend.setStyle("-fx-background-color: #800000; -fx-font: 15 times-new-roman; -fx-text-fill: white;" +
                "-fx-border-color: white; -fx-border-radius: 5px; -fx-background-radius: 5 5 5 5;");
        defend.setMaxHeight(50);
        defend.setMaxWidth(100);
        defend.setLayoutX(723);
        defend.setLayoutY(585);
        ...
        takeCards.setStyle("-fx-background-color: #800000; -fx-font: 15 times-new-roman; -fx-text-fill: white;" +
                "-fx-border-color: white; -fx-border-radius: 5px; -fx-background-radius: 5 5 5 5;");
        takeCards.setMaxHeight(50);
        takeCards.setMaxWidth(150);
        takeCards.setLayoutX(710);
        takeCards.setLayoutY(630);
    ...
    private void updateHandList(List<Card> list, StackPane stackPane) {
        stackPane.getChildren().clear();
        int j = 0;
    ...
    public void DefButMouseEvent(MouseEvent mouseEvent) {
        defButClicked = true;
        int index = 0;
    ...
    public void TakeCardsButMouseEvent(MouseEvent mouseEvent) {
        takeCardsButClicked = true;
        durak.pickUpCards(durak.getUserHand(), attack);
        durak.addInEnemyMoveList(attack);
    }

    private void durak(Hand userhand, Hand enemyHand) {
            ...
            if (durak.isEnemyTurn()) {
                ...
                while (!end) {
                    ...
                    for (int i = 0; i < attack.size(); i++) {
                        ...
                        ImageView image = new ImageView(ImageReturn.getImage(card));
                        StackPane.setAlignment(image, Pos.CENTER_LEFT);
                        StackPane.setMargin(image, new Insets(0, 0, 0, g));
                    ...
                    /**ЗДЕСЬ**/
                    //какой-нибудь тмп лист забабахать для атаки
                    if (takeCardsButClicked) {
                        takeCards = true;
                        end = true;
                    }
                    if (defButClicked) {
